...
const updatePreviews = (value) => {
  ...
  htmlPreview.href = `API/mailout_preview.php?prev=assets/mailout_bodies/html/${value}.html`;
  htmlPreview.target = '_blank';
  htmlPreview.innerHTML = 'Preview HTML';
  const textPreview = document.createElement('a');
  textPreview.href = `API/mailout_preview.php?prev=assets/mailout_bodies/text/${value}.txt`;
  textPreview.target = '_blank';
  textPreview.innerHTML = 'Preview Text';
  const subjectPreview = document.createElement('a');
  subjectPreview.href = `API/mailout_preview.php?prev=assets/mailout_bodies/subject/${value}.txt`;
